...
(
	...
	CONSTRAINT [FK_BridgeK12StaffCourseSectionRaces_FactK12StaffCourseSectionId] FOREIGN KEY ([FactK12StaffCourseSectionId]) REFERENCES [RDS].[FactK12StaffCourseSections] ([FactK12StaffCourseSectionId]) ON DELETE No Action ON UPDATE No Action,
