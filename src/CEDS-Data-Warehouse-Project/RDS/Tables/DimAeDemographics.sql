CREATE TABLE [RDS].[DimAeDemographics] (
    ...
    [EconomicDisadvantageStatusCode]               NVARCHAR (50)  CONSTRAINT [DF_DimAeDemographics_EconomicDisadvantageStatusCode] DEFAULT ('MISSING') NOT NULL,
    [EconomicDisadvantageStatusDescription]        NVARCHAR (200) CONSTRAINT [DF_DimAeDemographics_EconomicDisadvantageStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [HomelessnessStatusCode]                       NVARCHAR (50)  CONSTRAINT [DF_DimAeDemographics_HomelessnessStatusCode] DEFAULT ('MISSING') NOT NULL,
    [HomelessnessStatusDescription]                NVARCHAR (200) CONSTRAINT [DF_DimAeDemographics_HomelessnessStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [EnglishLearnerStatusCode]                     NVARCHAR (50)  CONSTRAINT [DF_DimAeDemographics_EnglishLearnerStatusCode] DEFAULT ('MISSING') NOT NULL,
    [EnglishLearnerStatusDescription]              NVARCHAR (200) CONSTRAINT [DF_DimAeDemographics_EnglishLearnerStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [MigrantStatusCode]                            NVARCHAR (50)  CONSTRAINT [DF_DimAeDemographics_MigrantStatusCode] DEFAULT ('MISSING') NOT NULL,
    [MigrantStatusDescription]                     NVARCHAR (200) CONSTRAINT [DF_DimAeDemographics_MigrantStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [MilitaryConnectedStudentIndicatorCode]        NVARCHAR (50)  CONSTRAINT [DF_DimAeDemographics_MilitaryConnectedStudentIndicatorCode] DEFAULT ('MISSING') NOT NULL,
    [MilitaryConnectedStudentIndicatorDescription] NVARCHAR (200) CONSTRAINT [DF_DimAeDemographics_MilitaryConnectedStudentIndicatorDescription] DEFAULT ('MISSING') NOT NULL,
    [HomelessPrimaryNighttimeResidenceCode]        NVARCHAR (50)  CONSTRAINT [DF_DimAeDemographics_HomelessPrimaryNighttimeResidenceCode] DEFAULT ('MISSING') NOT NULL,
    [HomelessPrimaryNighttimeResidenceDescription] NVARCHAR (MAX) CONSTRAINT [DF_DimAeDemographics_HomelessPrimaryNighttimeResidenceDescription] DEFAULT ('MISSING') NOT NULL,
    [HomelessUnaccompaniedYouthStatusCode]         NVARCHAR (50)  CONSTRAINT [DF_DimAeDemographics_HomelessUnaccompaniedYouthStatusCode] DEFAULT ('MISSING') NOT NULL,
    [HomelessUnaccompaniedYouthStatusDescription]  NVARCHAR (MAX) CONSTRAINT [DF_DimAeDemographics_HomelessUnaccompaniedYouthStatusDescription] DEFAULT ('MISSING') NOT NULL,
