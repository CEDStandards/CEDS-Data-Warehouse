CREATE TABLE [RDS].[DimDisciplineStatuses] (
    ...
    [DisciplinaryActionTakenCode]                           NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_DisciplinaryActionTakenCode] DEFAULT ('MISSING') NOT NULL,
    [DisciplinaryActionTakenDescription]                    NVARCHAR (200) CONSTRAINT [DF_DimDisciplineStatuses_DisciplinaryActionTakenDescription] DEFAULT ('MISSING') NOT NULL,
    [DisciplinaryActionTakenEdFactsCode]                    NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_DisciplinaryActionTakenEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [DisciplineMethodOfChildrenWithDisabilitiesCode]        NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_DisciplineMethodOfChildrenWithDisabilitiesCode] DEFAULT ('MISSING') NOT NULL,
    [DisciplineMethodOfChildrenWithDisabilitiesDescription] NVARCHAR (200) CONSTRAINT [DF_DimDisciplineStatuses_DisciplineMethodOfChildrenWithDisabilitiesDescription] DEFAULT ('MISSING') NOT NULL,
    [DisciplineMethodOfChildrenWithDisabilitiesEdFactsCode] NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_DisciplineMethodOfChildrenWithDisabilitiesEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [EducationalServicesAfterRemovalCode]                   NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_EducationalServicesAfterRemovalCode] DEFAULT ('MISSING') NOT NULL,
    [EducationalServicesAfterRemovalDescription]            NVARCHAR (200) CONSTRAINT [DF_DimDisciplineStatuses_EducationalServicesAfterRemovalDescription] DEFAULT ('MISSING') NOT NULL,
    [EducationalServicesAfterRemovalEdFactsCode]            NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_EducationalServicesAfterRemovalEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [IdeaInterimRemovalReasonCode]                          NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_IdeaInterimRemovalReasonCode] DEFAULT ('MISSING') NOT NULL,
    [IdeaInterimRemovalReasonDescription]                   NVARCHAR (200) CONSTRAINT [DF_DimDisciplineStatuses_IdeaInterimRemovalReasonDescription] DEFAULT ('MISSING') NOT NULL,
    [IdeaInterimRemovalReasonEdFactsCode]                   NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_IdeaInterimRemovalReasonEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [IdeaInterimRemovalCode]                                NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_IdeaInterimRemovalCode] DEFAULT ('MISSING') NOT NULL,
    [IdeaInterimRemovalDescription]                         NVARCHAR (200) CONSTRAINT [DF_DimDisciplineStatuses_IdeaInterimRemovalDescription] DEFAULT ('MISSING') NOT NULL,
    [IdeaInterimRemovalEdFactsCode]                         NVARCHAR (50)  CONSTRAINT [DF_DimDisciplineStatuses_IdeaInterimRemovalEdFactsCode] DEFAULT ('MISSING') NOT NULL,
