CREATE TABLE [RDS].[DimK12SchoolStatuses] (
    ...
    [MagnetOrSpecialProgramEmphasisSchoolCode]                            NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_MagnetOrSpecialProgramEmphasisSchoolCode] DEFAULT ('MISSING') NOT NULL,
    [MagnetOrSpecialProgramEmphasisSchoolDescription]                     NVARCHAR (200) CONSTRAINT [DF_DimK12SchoolStatuses_MagnetOrSpecialProgramEmphasisSchoolDescription] DEFAULT ('MISSING') NOT NULL,
    [MagnetOrSpecialProgramEmphasisSchoolEdFactsCode]                     NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_MagnetOrSpecialProgramEmphasisSchoolEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [NslpStatusCode]                                                      NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_NslpStatusCode] DEFAULT ('MISSING') NOT NULL,
    [NslpStatusDescription]                                               NVARCHAR (200) CONSTRAINT [DF_DimK12SchoolStatuses_NslpStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [NslpStatusEdFactsCode]                                               NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_NslpStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [SharedTimeIndicatorCode]                                             NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_SharedTimeIndicatorCode] DEFAULT ('MISSING') NOT NULL,
    [SharedTimeIndicatorDescription]                                      NVARCHAR (200) CONSTRAINT [DF_DimK12SchoolStatuses_SharedTimeIndicatorDescription] DEFAULT ('MISSING') NOT NULL,
    [SharedTimeIndicatorEdFactsCode]                                      NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_SharedTimeIndicatorEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [VirtualSchoolStatusCode]                                             NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_VirtualSchoolStatusCode] DEFAULT ('MISSING') NOT NULL,
    [VirtualSchoolStatusDescription]                                      NVARCHAR (200) CONSTRAINT [DF_DimK12SchoolStatuses_VirtualSchoolStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [VirtualSchoolStatusEdFactsCode]                                      NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_VirtualSchoolStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [SchoolImprovementStatusCode]                                         NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_SchoolImprovementStatusCode] DEFAULT ('MISSING') NOT NULL,
    [SchoolImprovementStatusDescription]                                  NVARCHAR (200) CONSTRAINT [DF_DimK12SchoolStatuses_SchoolImprovementStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [SchoolImprovementStatusEdFactsCode]                                  NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_SchoolImprovementStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [PersistentlyDangerousStatusCode]                                     NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_PersistentlyDangerousStatusCode] DEFAULT ('MISSING') NOT NULL,
    [PersistentlyDangerousStatusDescription]                              NVARCHAR (200) CONSTRAINT [DF_DimK12SchoolStatuses_PersistentlyDangerousStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [PersistentlyDangerousStatusEdFactsCode]                              NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_PersistentlyDangerousStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [StatePovertyDesignationCode]                                         NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_StatePovertyDesignationCode] DEFAULT ('MISSING') NOT NULL,
    [StatePovertyDesignationDescription]                                  NVARCHAR (200) CONSTRAINT [DF_DimK12SchoolStatuses_StatePovertyDesignationDescription] DEFAULT ('MISSING') NOT NULL,
    [StatePovertyDesignationEdFactsCode]                                  NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_StatePovertyDesignationEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [ProgressAchievingEnglishLanguageProficiencyIndicatorTypeCode]        NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_ProgressAchievingEnglishLanguageProficiencyIndicatorTypeCode] DEFAULT ('MISSING') NOT NULL,
    [ProgressAchievingEnglishLanguageProficiencyIndicatorTypeDescription] NVARCHAR (200) CONSTRAINT [DF_DimK12SchoolStatuses_ProgressAchievingEnglishLanguageProficiencyIndicatorTypeDescription] DEFAULT ('MISSING') NOT NULL,
    [ProgressAchievingEnglishLanguageProficiencyIndicatorTypeEdFactsCode] NVARCHAR (50)  CONSTRAINT [DF_DimK12SchoolStatuses_ProgressAchievingEnglishLanguageProficiencyIndicatorTypeEdFactsCode] DEFAULT ('MISSING') NOT NULL,
