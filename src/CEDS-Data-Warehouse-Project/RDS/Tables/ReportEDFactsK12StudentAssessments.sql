CREATE TABLE [RDS].[ReportEDFactsK12StudentAssessments](
	...
	[ASSESSMENTREGISTRATIONPARTICIPATIONINDICATOR] [nvarchar](50) NULL,
	...
	[TITLEIINDICATOR] [varchar](50) NULL,
	...
	[ASSESSMENTTYPEADMINISTERED] [nvarchar](50) NULL,
 ...
 CONSTRAINT [PK_ReportEDFactsK12StudentAssessments] PRIMARY KEY CLUSTERED 
(
	[ReportEDFactsK12StudentAssessmentId] ASC
...
EXEC sys.sp_addextendedproperty @name=N'CEDS_Def_Desc', @value=N'The type of Title I program offered in the school or district.' , @level0type=N'SCHEMA',@level0name=N'RDS', @level1type=N'TABLE',@level1name=N'ReportEdFactsK12StudentAssessments', @level2type=N'COLUMN',@level2name=N'TITLEIINDICATOR'
GO

EXEC sys.sp_addextendedproperty @name=N'CEDS_Element', @value=N'Title I Program Type' , @level0type=N'SCHEMA',@level0name=N'RDS', @level1type=N'TABLE',@level1name=N'ReportEdFactsK12StudentAssessments', @level2type=N'COLUMN',@level2name=N'TITLEIINDICATOR'
GO

EXEC sys.sp_addextendedproperty @name=N'CEDS_GlobalId', @value=N'000284' , @level0type=N'SCHEMA',@level0name=N'RDS', @level1type=N'TABLE',@level1name=N'ReportEdFactsK12StudentAssessments', @level2type=N'COLUMN',@level2name=N'TITLEIINDICATOR'
GO

EXEC sys.sp_addextendedproperty @name=N'CEDS_URL', @value=N'https://ceds.ed.gov/CEDSElementDetails.aspx?TermId=21284' , @level0type=N'SCHEMA',@level0name=N'RDS', @level1type=N'TABLE',@level1name=N'ReportEdFactsK12StudentAssessments', @level2type=N'COLUMN',@level2name=N'TITLEIINDICATOR'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'See the CEDS_GlobalId, CEDS_Element, CEDS_URL, and CEDS_Def_Desc extended properties.' , @level0type=N'SCHEMA',@level0name=N'RDS', @level1type=N'TABLE',@level1name=N'ReportEdFactsK12StudentAssessments', @level2type=N'COLUMN',@level2name=N'TITLEIINDICATOR'
GO
