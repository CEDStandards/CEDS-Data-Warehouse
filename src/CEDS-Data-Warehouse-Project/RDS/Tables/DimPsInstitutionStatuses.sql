CREATE TABLE [RDS].[DimPsInstitutionStatuses] (
    ...
    [LevelOfInstitutionCode]                     NVARCHAR (50)  CONSTRAINT [DF_DimPsInstitutionStatuses_LevelOfInstitutionCode] DEFAULT ('MISSING') NOT NULL,
    [LevelOfInstitutionDescription]              NVARCHAR (200) CONSTRAINT [DF_DimPsInstitutionStatuses_LevelOfInstitutionDescription] DEFAULT ('MISSING') NOT NULL,
    [ControlOfInstitutionCode]                   NVARCHAR (50)  CONSTRAINT [DF_DimPsInstitutionStatuses_ControlOfInstitutionCode] DEFAULT ('MISSING') NOT NULL,
    [ControlOfInstitutionDescription]            NVARCHAR (200) CONSTRAINT [DF_DimPsInstitutionStatuses_ControlOfInstitutionDescription] DEFAULT ('MISSING') NOT NULL,
    [VirtualIndicatorCode]                       NVARCHAR (50)  CONSTRAINT [DF_DimPsInstitutionStatuses_VirtualIndicatorCode] DEFAULT ('MISSING') NOT NULL,
    [VirtualIndicatorDescription]                NVARCHAR (200) CONSTRAINT [DF_DimPsInstitutionStatuses_VirtualIndicatorDescription] DEFAULT ('MISSING') NOT NULL,
    [CarnegieBasicClassificationCode]            NVARCHAR (50)  CONSTRAINT [DF_DimPsInstitutionStatuses_CarnegieBasicClassificationCode] DEFAULT ('MISSING') NOT NULL,
    [CarnegieBasicClassificationDescription]     NVARCHAR (200) CONSTRAINT [DF_DimPsInstitutionStatuses_CarnegieBasicClassificationDescription] DEFAULT ('MISSING') NOT NULL,
    [MostPrevalentLevelOfInstitutionCode]        NVARCHAR (50)  CONSTRAINT [DF_DimPsInstitutionStatuses_MostPrevalentLevelOfInstitutionCode] DEFAULT ('MISSING') NOT NULL,
    [MostPrevalentLevelOfInstitutionDescription] NVARCHAR (200) CONSTRAINT [DF_DimPsInstitutionStatuses_MostPrevalentLevelOfInstitutionDescription] DEFAULT ('MISSING') NOT NULL,
    [PredominantCalendarSystemCode]              NVARCHAR (50)  CONSTRAINT [DF_DimPsInstitutionStatuses_PredominantCalendarSystemCode] DEFAULT ('MISSING') NOT NULL,
    [PredominantCalendarSystemDescription]       NVARCHAR (200) CONSTRAINT [DF_DimPsInstitutionStatuses_PredominantCalendarSystemDescription] DEFAULT ('MISSING') NOT NULL,
