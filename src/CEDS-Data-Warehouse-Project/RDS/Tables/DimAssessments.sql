CREATE TABLE [RDS].[DimAssessments] (
    ...
    [AssessmentTypeCode]                                     NVARCHAR (100) CONSTRAINT [DF_DimAssessments_AssessmentTypeCode] DEFAULT ('MISSING') NOT NULL,
    [AssessmentTypeDescription]                              NVARCHAR (300) CONSTRAINT [DF_DimAssessments_AssessmentTypeDescription] DEFAULT ('MISSING') NOT NULL,
    [AssessmentTypeEdFactsCode]                              NVARCHAR (100) CONSTRAINT [DF_DimAssessments_AssessmentTypeEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [AssessmentAcademicSubjectCode]                          NVARCHAR (100) CONSTRAINT [DF_DimAssessments_AssessmentAcademicSubjectCode] DEFAULT ('MISSING') NOT NULL,
    [AssessmentAcademicSubjectDescription]                   NVARCHAR (300) CONSTRAINT [DF_DimAssessments_AssessmentAcademicSubjectDescription] DEFAULT ('MISSING') NOT NULL,
    [AssessmentAcademicSubjectEdFactsCode]                   NVARCHAR (50)  CONSTRAINT [DF_DimAssessments_AssessmentAcademicSubjectEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [AssessmentTypeAdministeredCode]                         NVARCHAR (100) CONSTRAINT [DF_DimAssessments_AssessmentTypeAdministeredCode] DEFAULT ('MISSING') NOT NULL,
    [AssessmentTypeAdministeredDescription]                  NVARCHAR (300) CONSTRAINT [DF_DimAssessments_AssessmentTypeAdministeredDescription] DEFAULT ('MISSING') NOT NULL,
    [AssessmentTypeAdministeredEdFactsCode]                  NVARCHAR (100) CONSTRAINT [DF_DimAssessments_AssessmentTypeAdministeredEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [AssessmentTypeAdministeredToEnglishLearnersCode]        NVARCHAR (100) CONSTRAINT [DF_DimAssessments_AssessmentTypeAdministeredToEnglishLearnersCode] DEFAULT ('MISSING') NOT NULL,
    [AssessmentTypeAdministeredToEnglishLearnersDescription] NVARCHAR (300) CONSTRAINT [DF_DimAssessments_AssessmentTypeAdministeredToEnglishLearnersDescription] DEFAULT ('MISSING') NOT NULL,
    [AssessmentTypeAdministeredToEnglishLearnersEdFactsCode] NVARCHAR (100) CONSTRAINT [DF_DimAssessments_AssessmentTypeAdministeredToEnglishLearnersEdFactsCode] DEFAULT ('MISSING') NOT NULL,
