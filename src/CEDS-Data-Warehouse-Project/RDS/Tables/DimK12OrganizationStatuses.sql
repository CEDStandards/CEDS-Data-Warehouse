CREATE TABLE [RDS].[DimK12OrganizationStatuses] (
    ...
    [ReapAlternativeFundingStatusCode]                   NVARCHAR (50)  CONSTRAINT [DF_DimK12OrganizationStatuses_ReapAlternativeFundingStatusCode] DEFAULT ('MISSING') NOT NULL,
    [ReapAlternativeFundingStatusDescription]            NVARCHAR (MAX) CONSTRAINT [DF_DimK12OrganizationStatuses_ReapAlternativeFundingStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [ReapAlternativeFundingStatusEdFactsCode]            NVARCHAR (50)  CONSTRAINT [DF_DimK12OrganizationStatuses_ReapAlternativeFundingStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [GunFreeSchoolsActReportingStatusCode]               NVARCHAR (50)  CONSTRAINT [DF_DimK12OrganizationStatuses_GunFreeSchoolsActReportingStatusCode] DEFAULT ('MISSING') NOT NULL,
    [GunFreeSchoolsActReportingStatusDescription]        NVARCHAR (MAX) CONSTRAINT [DF_DimK12OrganizationStatuses_GunFreeSchoolsActReportingStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [GunFreeSchoolsActReportingStatusEdFactsCode]        NVARCHAR (50)  CONSTRAINT [DF_DimK12OrganizationStatuses_GunFreeSchoolsActReportingStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [HighSchoolGraduationRateIndicatorStatusCode]        NVARCHAR (50)  CONSTRAINT [DF_DimK12OrganizationStatuses_HighSchoolGraduationRateIndicatorStatusCode] DEFAULT ('MISSING') NOT NULL,
    [HighSchoolGraduationRateIndicatorStatusDescription] NVARCHAR (MAX) CONSTRAINT [DF_DimK12OrganizationStatuses_HighSchoolGraduationRateIndicatorStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [HighSchoolGraduationRateIndicatorStatusEdFactsCode] NVARCHAR (50)  CONSTRAINT [DF_DimK12OrganizationStatuses_HighSchoolGraduationRateIndicatorStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [McKinneyVentoSubgrantRecipientCode]                 NVARCHAR (50)  CONSTRAINT [DF_DimK12OrganizationStatuses_McKinneyVentoSubgrantRecipientCode] DEFAULT ('MISSING') NOT NULL,
    [McKinneyVentoSubgrantRecipientDescription]          NVARCHAR (MAX) CONSTRAINT [DF_DimK12OrganizationStatuses_McKinneyVentoSubgrantRecipientDescription] DEFAULT ('MISSING') NOT NULL,
    [McKinneyVentoSubgrantRecipientEdFactsCode]          NVARCHAR (50)  CONSTRAINT [DF_DimK12OrganizationStatuses_McKinneyVentoSubgrantRecipientEdFactsCode] DEFAULT ('MISSING') NOT NULL,
