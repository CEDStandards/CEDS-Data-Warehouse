CREATE TABLE [RDS].[DimTitleIIIStatuses] (
    ...
    [ProgramParticipationTitleIIILiepCode]              NVARCHAR (50)  CONSTRAINT [DF_DimTitleIIIStatuses_ProgramParticipationTitleIIILiepCode] DEFAULT ('MISSING') NOT NULL,
    [ProgramParticipationTitleIIILiepDescription]       NVARCHAR (200) CONSTRAINT [DF_DimTitleIIIStatuses_ProgramParticipationTitleIIILiepDescription] DEFAULT ('MISSING') NOT NULL,
    [TitleIIIImmigrantParticipationStatusCode]          NVARCHAR (50)  CONSTRAINT [DF_DimTitleIIIStatuses_TitleIIIImmigrantParticipationStatusCode] DEFAULT ('MISSING') NOT NULL,
    [TitleIIIImmigrantParticipationStatusDescription]   NVARCHAR (200) CONSTRAINT [DF_DimTitleIIIStatuses_TitleIIIImmigrantParticipationStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [TitleIIIImmigrantParticipationStatusEdFactsCode]   NVARCHAR (50)  CONSTRAINT [DF_DimTitleIIIStatuses_TitleIIIImmigrantParticipationStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [ProficiencyStatusCode]                             NVARCHAR (50)  CONSTRAINT [DF_DimTitleIIIStatuses_ProficiencyStatusCode] DEFAULT ('MISSING') NOT NULL,
    [ProficiencyStatusDescription]                      NVARCHAR (100) CONSTRAINT [DF_DimTitleIIIStatuses_ProficiencyStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [ProficiencyStatusEdFactsCode]                      NVARCHAR (50)  CONSTRAINT [DF_DimTitleIIIStatuses_ProficiencyStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [TitleIIIAccountabilityProgressStatusCode]          NVARCHAR (50)  CONSTRAINT [DF_DimTitleIIIStatuses_TitleIIIAccountabilityProgressStatusCode] DEFAULT ('MISSING') NOT NULL,
    [TitleIIIAccountabilityProgressStatusDescription]   NVARCHAR (100) CONSTRAINT [DF_DimTitleIIIStatuses_TitleIIIAccountabilityProgressStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [TitleIIIAccountabilityProgressStatusEdFactsCode]   NVARCHAR (50)  CONSTRAINT [DF_DimTitleIIIStatuses_TitleIIIAccountabilityProgressStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
