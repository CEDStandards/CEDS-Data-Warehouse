...
(
	...
	[K12StaffPersonId] 										INT 			CONSTRAINT [DF_FactK12StaffAssessments_K12StaffPersonId] DEFAULT ((-1)) NOT NULL,
	...
	CONSTRAINT [FK_FactK12StaffAssessments_AssessmentRegistrationGradeLevelToBeAssessedId] FOREIGN KEY ([AssessmentRegistrationGradeLevelToBeAssessedId]) REFERENCES [RDS].[DimGradeLevels] ([AssessmentRegistrationGradeLevelToBeAssessedId]) ON DELETE No Action ON UPDATE No Action,
	...
	CONSTRAINT [FK_FactK12StaffAssessments_AssessmentParticipationSessionId] FOREIGN KEY ([AssessmentParticipationSessionId]) REFERENCES [RDS].[DimAssessmentParticipationSessions] ([AssessmentParticipationSessionId]) ON DELETE No Action ON UPDATE No Action,
