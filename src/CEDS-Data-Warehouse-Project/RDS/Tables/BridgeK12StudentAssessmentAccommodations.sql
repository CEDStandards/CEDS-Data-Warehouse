CREATE TABLE [RDS].[BridgeK12StudentAssessmentAccommodations] (
    [BridgeK12StudentAssessmentAccommodationId] INT IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_BridgeK12StudentAssessmentAccommodations] PRIMARY KEY CLUSTERED ([BridgeK12StudentAssessmentAccommodationId] ASC),
