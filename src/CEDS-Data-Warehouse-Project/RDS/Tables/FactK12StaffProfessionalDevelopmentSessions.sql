...
(
	...
	[NumberOfCreditsEarnedClockHours] decimal(5,2) NULL,
	[IeuId] int NULL,
	...
	CONSTRAINT [FK_FactK12StaffProfessionalDevelopmentSessions_K12JobPositionStatusId] FOREIGN KEY ([K12JobPositionStatusId]) REFERENCES [RDS].[DimK12JobPositionStatuses] ([DimK12JobPositionStatusId]) ON DELETE No Action ON UPDATE No Action,
...
CREATE NONCLUSTERED INDEX [IXFK_FactK12StaffProfessionalDevelopmentSessions_K12JobPositionStatusId] 
 ON [RDS].[FactK12StaffProfessionalDevelopmentSessions] ([K12JobPositionStatusId] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IXFK_FactK12StaffProfessionalDevelopmentSessions_TeachingCredentialStatusId] 
 ON [RDS].[FactK12StaffProfessionalDevelopmentSessions] ([TeachingCredentialStatusId] ASC)
GO
