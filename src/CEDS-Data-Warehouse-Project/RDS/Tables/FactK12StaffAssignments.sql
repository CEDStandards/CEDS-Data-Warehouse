...
(
	...
	[K12JobPositionStatusId] int NULL,
	...
	CONSTRAINT [FK_FactK12StaffAssignments_K12JobPositionStatusId] FOREIGN KEY ([K12JobPositionStatusId]) REFERENCES [RDS].[DimK12JobPositionStatuses] ([DimK12JobPositionStatusId]) ON DELETE No Action ON UPDATE No Action,
...
CREATE NONCLUSTERED INDEX [IXFK_FactK12StaffAssignments_TeachingCredentialStatusId]
 ON [RDS].[FactK12StaffAssignments] ([TeachingCredentialStatusId] ASC)
GO
