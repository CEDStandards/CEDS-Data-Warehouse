CREATE TABLE [RDS].[DimMigrantStatuses] (
    ...
    [MigrantStatusCode]                                NVARCHAR (100) CONSTRAINT [DF_DimMigrantStatuses_MigrantStatusCode] DEFAULT ('MISSING') NOT NULL,
    [MigrantStatusDescription]                         NVARCHAR (300) CONSTRAINT [DF_DimMigrantStatuses_MigrantStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [MigrantStatusEdFactsCode]                         NVARCHAR (50)  CONSTRAINT [DF_DimMigrantStatuses_MigrantStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [MigrantEducationProgramEnrollmentTypeCode]        NVARCHAR (100) CONSTRAINT [DF_DimMigrantStatuses_MigrantEducationProgramEnrollmentTypeCode] DEFAULT ('MISSING') NOT NULL,
    [MigrantEducationProgramEnrollmentTypeDescription] NVARCHAR (300) CONSTRAINT [DF_DimMigrantStatuses_MigrantEducationProgramEnrollmentTypeDescription] DEFAULT ('MISSING') NOT NULL,
    [ContinuationOfServicesReasonCode]                 NVARCHAR (100) CONSTRAINT [DF_DimMigrantStatuses_ContinuationOfServicesReasonCode] DEFAULT ('MISSING') NOT NULL,
    [ContinuationOfServicesReasonDescription]          NVARCHAR (300) CONSTRAINT [DF_DimMigrantStatuses_ContinuationOfServicesReasonDescription] DEFAULT ('MISSING') NOT NULL,
    [MEPContinuationOfServicesStatusCode]              NVARCHAR (100) CONSTRAINT [DF_DimMigrantStatuses_MEPContinuationOfServicesStatusCode] DEFAULT ('MISSING') NOT NULL,
    [MEPContinuationOfServicesStatusDescription]       NVARCHAR (300) CONSTRAINT [DF_DimMigrantStatuses_MEPContinuationOfServicesStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [MEPContinuationOfServicesStatusEdFactsCode]       NVARCHAR (50)  CONSTRAINT [DF_DimMigrantStatuses_MEPContinuationOfServicesStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [ConsolidatedMEPFundsStatusCode]                   NVARCHAR (100) CONSTRAINT [DF_DimMigrantStatuses_ConsolidatedMEPFundsStatusCode] DEFAULT ('MISSING') NOT NULL,
    [ConsolidatedMEPFundsStatusDescription]            NVARCHAR (300) CONSTRAINT [DF_DimMigrantStatuses_ConsolidatedMEPFundsStatusDescription] DEFAULT ('MISSING') NOT NULL,
    [ConsolidatedMEPFundsStatusEdFactsCode]            NVARCHAR (50)  CONSTRAINT [DF_DimMigrantStatuses_ConsolidatedMEPFundsStatusEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [MigrantEducationProgramServicesTypeCode]          NVARCHAR (100) CONSTRAINT [DF_DimMigrantStatuses_MigrantEducationProgramServicesTypeCode] DEFAULT ('MISSING') NOT NULL,
    [MigrantEducationProgramServicesTypeDescription]   NVARCHAR (300) CONSTRAINT [DF_DimMigrantStatuses_MigrantEducationProgramServicesTypeDescription] DEFAULT ('MISSING') NOT NULL,
    [MigrantEducationProgramServicesTypeEdFactsCode]   NVARCHAR (50)  CONSTRAINT [DF_DimMigrantStatuses_MigrantEducationProgramServicesTypeEdFactsCode] DEFAULT ('MISSING') NOT NULL,
    [MigrantPrioritizedForServicesCode]                NVARCHAR (100) CONSTRAINT [DF_DimMigrantStatuses_MigrantPrioritizedForServicesCode] DEFAULT ('MISSING') NOT NULL,
    [MigrantPrioritizedForServicesDescription]         NVARCHAR (300) CONSTRAINT [DF_DimMigrantStatuses_MigrantPrioritizedForServicesDescription] DEFAULT ('MISSING') NOT NULL,
    [MigrantPrioritizedForServicesEdFactsCode]         NVARCHAR (50)  CONSTRAINT [DF_DimMigrantStatuses_MigrantPrioritizedForServicesEdFactsCode] DEFAULT ('MISSING') NOT NULL,
