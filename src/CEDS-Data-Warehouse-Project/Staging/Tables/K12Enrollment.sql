CREATE TABLE [Staging].[K12Enrollment] (
    ...
    [EndOfTermStatus]                                     NVARCHAR (50)  NULL,
    [RetentionExemptionReason]                            NVARCHAR (50)  NULL,
    [AdjustedExitOrWithdrawalType]                        NVARCHAR (50)  NULL,
    [DropoutReasonType]                                   NVARCHAR (50)  NULL,
    [StudentDropoutStatus]                                NVARCHAR (50)  NULL,
